...
namespace EchoOfTheTimes.Persistence
{
    public class PersistenceService : MonoBehaviour
    {
        ...
        private void HandleLevelCompleted(int collected)
        {
            ...
            // ѕолучаем начальный статус уровн€ перед завершением
            var initialLevelStatus = GetCurrentLevelStatus(newDataToSave);

            // ќбновл€ем статус текущего уровн€ на завершЄнный и определ€ем индексы главы и уровн€
            ...
            // 1. ѕроверка перепрохождени€: если уровень уже завершЄн, просто загружаем следующий уровень при условии что следующа€ глава уже открыта
            ...
            // 2. ѕроверка завершени€ главы: если все коллектаблы собраны, устанавливаем статус `Completed` и открываем следующую главу и еЄ первый уровень
            else if (allCollectablesCollectedInChapter && lastLoadedChapterIndex < newDataToSave.Data.Count - 1)
            {
                ...
                UnlockNextChapter(newDataToSave, lastLoadedChapterIndex + 1); // “олько перва€ глава и уровень
            ...
            // 3. ≈сли это последний уровень главы, но не все коллектаблы собраны, возвращаем игрока в меню уровней текущей главы
            ...
            {
                // ќбычный переход к следующему уровню
        ...
        {
            // –азблокируем только следующую главу и еЄ первый уровень
        ...
        // ћетод дл€ разблокировки следующего уровн€, если он заблокирован
        ...
        {
            // «агружаем следующий уровень в текущей главе
            ...
            {
                return newDataToSave.Data[chapterIndex].Levels[levelIndex].FullName; // ѕоследний уровень последней главы
            }
        }
        ...
        //    // ѕроверить все главы -- одна из них может открытьс€, так как собрано нужное кол-во коллектаблов
